...
ResponderEventPlugin.injection.injectGlobalResponderHandler({
  onChange: function(from, to, blockNativeResponder) {
    (from || to).stateNode.canonical._internalInstanceHandle
      ? (from &&
          nativeFabricUIManager.setIsJSResponder(from.stateNode.node, !1),
        to && nativeFabricUIManager.setIsJSResponder(to.stateNode.node, !0))
      : null !== to
          ...
          try {
            ...
            if (0 !== (fiber$jscomp$0.flags & 68))
              switch (fiber$jscomp$0.tag) {
                ...
                case 3:
                  ...
                  if (null !== updateQueue$85) {
                    ...
                    if (null !== fiber$jscomp$0.child)
                      switch (fiber$jscomp$0.child.tag) {
                        case 5:
                          finishedRoot =
                            fiber$jscomp$0.child.stateNode.canonical;
                          break;
                        case 1:
                  ...
                  break;
                case 5:
                  null === current && fiber$jscomp$0.flags & 4 && shim();
                  break;
                case 6:
                  break;
                case 4:
            ...
            if (fiber$jscomp$0.flags & 256) {
              ...
              if (null !== ref) {
                ...
                switch (fiber$jscomp$0.tag) {
                  case 5:
                    finishedRoot = instance$jscomp$0.canonical;
                    break;
                  default:
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_970 = {
...
var internals$jscomp$inline_1231 = {
  bundleType: devToolsConfig$jscomp$inline_970.bundleType,
  version: devToolsConfig$jscomp$inline_970.version,
  rendererPackageName: devToolsConfig$jscomp$inline_970.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_970.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_970.findFiberByHostInstance ||
