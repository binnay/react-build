...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$146;
  if (canUseDOM) {
    var isSupported$jscomp$inline_273 = "oninput" in document;
    if (!isSupported$jscomp$inline_273) {
      var element$jscomp$inline_274 = document.createElement("div");
      element$jscomp$inline_274.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_273 =
        "function" === typeof element$jscomp$inline_274.oninput;
    }
    JSCompiler_inline_result$jscomp$146 = isSupported$jscomp$inline_273;
  } else JSCompiler_inline_result$jscomp$146 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$146 &&
...
for (
  var i$jscomp$inline_314 = 0;
  i$jscomp$inline_314 < simpleEventPluginEvents.length;
  i$jscomp$inline_314++
) {
  var eventName$jscomp$inline_315 =
      simpleEventPluginEvents[i$jscomp$inline_314],
    domEventName$jscomp$inline_316 = eventName$jscomp$inline_315.toLowerCase(),
    capitalizedEvent$jscomp$inline_317 =
      eventName$jscomp$inline_315[0].toUpperCase() +
      eventName$jscomp$inline_315.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_316,
    "on" + capitalizedEvent$jscomp$inline_317
  );
}
  ...
  if (didBailout)
    for (var child$92 = completedWork.child; null !== child$92; )
      (newChildLanes |= child$92.lanes | child$92.childLanes),
        (subtreeFlags |= child$92.subtreeFlags & 262144),
        (subtreeFlags |= child$92.flags & 262144),
...
function unwindWork(workInProgress) {
  switch (workInProgress.tag) {
    ...
    case 3:
      ...
      if (0 !== (flags & 128)) throw Error(formatProdErrorMessage(285));
            ...
            if (0 !== (fiber$jscomp$0.flags & 68))
              switch (fiber$jscomp$0.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$112 = fiber$jscomp$0.updateQueue;
                  if (null !== updateQueue$112) {
                    current = null;
                    ...
                    commitUpdateQueue(fiber$jscomp$0, updateQueue$112, current);
                  }
                  break;
                case 5:
                  var instance$114 = fiber$jscomp$0.stateNode;
                  null === current &&
                    fiber$jscomp$0.flags & 4 &&
                    ((current = instance$114),
...
var COMPONENT_TYPE = 0,
  ...
  TEXT_TYPE = 4;
if ("function" === typeof Symbol && Symbol.for) {
  var symbolFor$120 = Symbol.for;
  COMPONENT_TYPE = symbolFor$120("selector.component");
  HAS_PSEUDO_CLASS_TYPE = symbolFor$120("selector.has_pseudo_class");
  ROLE_TYPE = symbolFor$120("selector.role");
  TEST_NAME_TYPE = symbolFor$120("selector.test_id");
  TEXT_TYPE = symbolFor$120("selector.text");
}
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$106 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$106.tag)) {
              var nextState = workInProgress$106.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$106.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$106.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$106.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (
                0 === (workInProgress$106.mode & 1) &&
                workInProgress$106 !== returnFiber
              ) {
                workInProgress$106.flags |= 128;
              ...
              workInProgress$106.flags |= 16384;
              workInProgress$106.lanes = thrownValue;
              break a;
            }
            workInProgress$106 = workInProgress$106.return;
          } while (null !== workInProgress$106);
          value = Error(
        ...
        workInProgress$106 = returnFiber;
        do {
          switch (workInProgress$106.tag) {
            case 3:
              root = value;
              workInProgress$106.flags |= 16384;
              thrownValue &= -thrownValue;
              workInProgress$106.lanes |= thrownValue;
              var update$107 = createRootErrorUpdate(
                workInProgress$106,
                root,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$106, update$107);
              break a;
            case 1:
              root = value;
              var ctor = workInProgress$106.type,
                instance = workInProgress$106.stateNode;
              if (
                0 === (workInProgress$106.flags & 128) &&
                ...
                thrownValue &= -thrownValue;
                workInProgress$106.lanes |= thrownValue;
                var update$110 = createClassErrorUpdate(
                  workInProgress$106,
                  root,
                  thrownValue
                );
                enqueueCapturedUpdate(workInProgress$106, update$110);
                break a;
              }
          }
          workInProgress$106 = workInProgress$106.return;
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  if (0 !== (finishedWork.subtreeFlags & 8054) || remainingLanes) {
    ...
    executionContext |= 16;
    ReactCurrentOwner$2.current = null;
    var shouldFireAfterActiveInstanceBlur$125 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffects(root, renderPriorityLevel, finishedWork);
    shouldFireAfterActiveInstanceBlur$125 &&
      ((_enabled = !0),
  ...
  switch (workInProgress.tag) {
    ...
    case 16:
      ...
      a: {
        null !== current &&
          ...
          (workInProgress.flags |= 2));
        current = workInProgress.pendingProps;
        var init = nextValue._init;
        nextValue = init(nextValue._payload);
        workInProgress.type = nextValue;
        init = workInProgress.tag = resolveLazyComponentTag(nextValue);
        ...
        throw Error(formatProdErrorMessage(306, nextValue, ""));
      }
      return workInProgress;
    case 0:
      return (
    ...
    case 3:
      ...
      if (updateLanes === nextValue)
        ...
        if ((nextValue = init.hydrate))
          (nextHydratableInstance = getNextHydratable(
            workInProgress.stateNode.containerInfo.firstChild
          )),
            (hydrationParentFiber = workInProgress),
            (nextValue = isHydrating = !0);
        if (nextValue) {
          current = init.mutableSourceEagerHydrationData;
          if (null != current)
            for (nextValue = 0; nextValue < current.length; nextValue += 2)
              (init = current[nextValue]),
                (init._workInProgressVersionPrimary = current[nextValue + 1]),
    ...
    case 5:
      ...
      var nextChildren = nextValue.children;
      shouldSetTextContent(updateLanes, nextValue)
        ? (nextChildren = null)
        : null !== init &&
    ...
    case 10:
      a: {
        ...
        init = nextValue.value;
        push(valueCursor, updateLanes._currentValue);
        updateLanes._currentValue = init;
        if (null !== nextChildren) {
          var oldValue = nextChildren.value;
          init = objectIs(oldValue, init)
            ? 0
            : ("function" === typeof updateLanes._calculateChangedBits
                ? updateLanes._calculateChangedBits(oldValue, init)
                : 1073741823) | 0;
          if (0 === init) {
            if (nextChildren.children === nextValue.children) {
              workInProgress = bailoutOnAlreadyFinishedWork(
                current,
                workInProgress,
                renderLanes
            ...
            for (
              nextChildren = workInProgress.child,
                null !== nextChildren && (nextChildren.return = workInProgress);
              null !== nextChildren;

            ) {
              var list = nextChildren.dependencies;
              if (null !== list) {
                oldValue = nextChildren.child;
                for (
                  ...
                  if (
                    ...
                    if (1 === nextChildren.tag) {
                      dependency = createUpdate(-1, renderLanes & -renderLanes);
                      dependency.tag = 2;
                      var updateQueue = nextChildren.updateQueue;
                      if (null !== updateQueue) {
                        updateQueue = updateQueue.shared;
                    ...
                    nextChildren.lanes |= renderLanes;
                    dependency = nextChildren.alternate;
                    null !== dependency && (dependency.lanes |= renderLanes);
                    scheduleWorkOnParentPath(nextChildren.return, renderLanes);
                    list.lanes |= renderLanes;
                    break;
                  }
                  dependency = dependency.next;
                }
              } else if (10 === nextChildren.tag)
                oldValue =
                  nextChildren.type === workInProgress.type
                    ? null
                    : nextChildren.child;
              else if (18 === nextChildren.tag) {
                oldValue = nextChildren.return;
                if (null === oldValue) throw Error(formatProdErrorMessage(341));
                oldValue.lanes |= renderLanes;
                list = oldValue.alternate;
                null !== list && (list.lanes |= renderLanes);
                scheduleWorkOnParentPath(oldValue, renderLanes);
                oldValue = nextChildren.sibling;
              } else oldValue = nextChildren.child;
              if (null !== oldValue) oldValue.return = nextChildren;
              else
                for (oldValue = nextChildren; null !== oldValue; ) {
                  if (oldValue === workInProgress) {
                    oldValue = null;
                    break;
                  }
                  nextChildren = oldValue.sibling;
                  if (null !== nextChildren) {
                    nextChildren.return = oldValue.return;
                    oldValue = nextChildren;
                    break;
                  }
                  oldValue = oldValue.return;
                }
              nextChildren = oldValue;
            }
        }
        reconcileChildren(
          current,
    ...
    case 9:
      return (
        ...
        prepareToReadContext(workInProgress, renderLanes),
        (nextValue = readContext(nextValue, init.unstable_observedBits)),
    ...
    case 14:
      return (
        (nextValue = workInProgress.type),
        (init = resolveDefaultProps(nextValue, workInProgress.pendingProps)),
        (init = resolveDefaultProps(nextValue.type, init)),
        updateMemoComponent(
          current,
          workInProgress,
          nextValue,
...
var IsThisRendererActing = { current: !1 },
  flushMockScheduler = Scheduler.unstable_flushAllWithoutAsserting,
...
attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$127 = fiber.stateNode;
      if (root$127.hydrate) {
        var lanes = getHighestPriorityLanes(root$127.pendingLanes);
        root$127.expiredLanes |= lanes & root$127.pendingLanes;
        ensureRootIsScheduled(root$127, now());
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1341 = {
    findFiberByHostInstance: getClosestInstanceFromNode,
    bundleType: 0,
    version: "17.0.2",
    rendererPackageName: "react-dom"
  };
var internals$jscomp$inline_1713 = {
  bundleType: devToolsConfig$jscomp$inline_1341.bundleType,
  version: devToolsConfig$jscomp$inline_1341.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1341.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1341.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1341.findFiberByHostInstance ||
