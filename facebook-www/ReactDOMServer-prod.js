...
var ReactDOMServerRenderer = (function() {
  ...
  _proto.render = function(child, context, parentNamespace) {
    ...
    if ("object" === typeof elementType && null !== elementType)
      switch (elementType.$$typeof) {
        case REACT_FORWARD_REF_TYPE:
          currentlyRenderingComponent = {};
          var nextChildren$14 = elementType.render(child.props, child.ref);
          nextChildren$14 = finishHooks(
            elementType.render,
            child.props,
            nextChildren$14,
            child.ref
          );
          nextChildren$14 = toArray(nextChildren$14);
          this.stack.push({
            type: null,
            domNamespace: parentNamespace,
            children: nextChildren$14,
            childIndex: 0,
            context: context,
            footer: ""
          });
        ...
        case REACT_CONTEXT_TYPE:
          ...
          nextChildren$14 = child.props;
          var threadID = this.threadID;
          validateContextBounds(elementType, threadID);
          elementType = toArray(
            nextChildren$14.children(elementType[threadID])
          );
          this.stack.push({
            type: child,
            domNamespace: parentNamespace,
        ...
        case REACT_LAZY_TYPE:
          return (
            (elementType = child.type),
            (nextChildren$14 = elementType._init),
            (elementType = nextChildren$14(elementType._payload)),
            (child = [
              React.createElement(
                elementType,
                Object.assign({ ref: child.ref }, child.props)
  ...
  _proto.renderDOM = function(element, context, parentNamespace) {
    ...
    for (out in initialValue)
      if (hasOwnProperty$1.call(initialValue, out)) {
