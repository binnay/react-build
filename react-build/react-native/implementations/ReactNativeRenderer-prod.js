...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1254 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1254.isDisabled &&
    hook$jscomp$inline_1254.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1254.inject(
        internals$jscomp$inline_1253
      )),
        (injectedHook = hook$jscomp$inline_1254);
    } catch (err) {}
}
