...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_303 = "oninput" in document;
    if (!isSupported$jscomp$inline_303) {
      var element$jscomp$inline_304 = document.createElement("div");
      element$jscomp$inline_304.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_303 =
        "function" === typeof element$jscomp$inline_304.oninput;
    }
    JSCompiler_inline_result$jscomp$179 = isSupported$jscomp$inline_303;
  } else JSCompiler_inline_result$jscomp$179 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$179 &&
...
for (
  var i$jscomp$inline_344 = 0;
  i$jscomp$inline_344 < simpleEventPluginEvents.length;
  i$jscomp$inline_344++
) {
  var eventName$jscomp$inline_345 =
      simpleEventPluginEvents[i$jscomp$inline_344],
    domEventName$jscomp$inline_346 = eventName$jscomp$inline_345.toLowerCase(),
    capitalizedEvent$jscomp$inline_347 =
      eventName$jscomp$inline_345[0].toUpperCase() +
      eventName$jscomp$inline_345.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_346,
    "on" + capitalizedEvent$jscomp$inline_347
  );
}
...
function formatLanes(laneOrLanes) {
  if (enableSchedulingProfiler) {
    var labels = [];
    laneOrLanes & 1 && labels.push("Sync");
    laneOrLanes & 2 && labels.push("SyncBatched");
    laneOrLanes & 4 && labels.push("InputDiscreteHydration");
    laneOrLanes & 8 && labels.push("InputDiscrete");
    laneOrLanes & 16 && labels.push("InputContinuousHydration");
    laneOrLanes & 32 && labels.push("InputContinuous");
    laneOrLanes & 64 && labels.push("DefaultHydration");
    laneOrLanes & 128 && labels.push("Default");
    laneOrLanes & 256 && labels.push("TransitionHydration");
    laneOrLanes & 8388096 && labels.push("Transition(s)");
    laneOrLanes & 125829120 && labels.push("Retry(s)");
    laneOrLanes & 134217728 && labels.push("SelectiveHydration");
    laneOrLanes & 268435456 && labels.push("IdleHydration");
    laneOrLanes & 536870912 && labels.push("Idle");
    laneOrLanes & 1073741824 && labels.push("Offscreen");
  } else labels = void 0;
  labels = null != labels ? labels.sort().join(",") : "";
...
enableSchedulingProfiler &&
  ...
  markAndClear("--react-init-17.0.2");
...
function markStateUpdateScheduled(fiber, lane) {
  enableSchedulingProfiler &&
    ...
    markAndClear("--schedule-state-update-" + formatLanes(lane) + "-" + fiber));
}
...
var classComponentUpdater = {
  ...
  enqueueForceUpdate: function(inst, callback) {
    ...
    enableSchedulingProfiler &&
      ...
      markAndClear(
        "--schedule-forced-update-" + formatLanes(inst) + "-" + callback
      ));
  }
};
  ...
  for (fiber = fiber.return; null !== fiber; ) {
    switch (fiber.tag) {
      ...
      case 3:
        var lane = requestUpdateLane(fiber),
          eventTime = requestEventTime(),
          root$54 = scheduleUpdateOnFiber(fiber, lane, eventTime);
        null !== root$54 && entangleTransitions(root$54, fiber, lane);
...
function dispatchAction(fiber, queue, action) {
  ...
  if (
    ...
    (didScheduleRenderPhaseUpdateDuringThisPass = didScheduleRenderPhaseUpdate = !0),
      ...
      null === action
        ? (update.next = update)
        : ((update.next = action.next), (action.next = update)),
    ...
    if (
      ...
      var pending$55 = queue.pending;
      null === pending$55
        ? (update.next = update)
        : ((update.next = pending$55.next), (pending$55.next = update));
      queue.pending = update;
    } else
      (pending$55 = queue.interleaved),
        null === pending$55
          ? ((update.next = update),
            null === interleavedQueues
    ...
    0 !== (lane & 8388096) &&
      null !== update &&
      ((action = queue.lanes),
      (action &= update.pendingLanes),
      (action |= lane),
      (queue.lanes = action),
      markRootEntangled(update, action));
  }
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$103.lanes | child$103.childLanes),
          (subtreeFlags |= child$103.subtreeFlags & 262144),
          (subtreeFlags |= child$103.flags & 262144),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$102.subtreeFlags & 262144),
          (subtreeFlags |= treeBaseDuration$102.flags & 262144),
                  ...
                  (props = renderLanes),
                    ...
                    null === current
                      ? ((props.childLanes = 0),
                        ...
                        (props.selfBaseDuration = 0),
                        (props.treeBaseDuration = 0))
                      : ((props.childLanes = current.childLanes),
                        (props.lanes = current.lanes),
                        (props.child = current.child),
                        (props.subtreeFlags = 0),
                        (props.deletions = null),
                        (props.memoizedProps = current.memoizedProps),
                        (props.memoizedState = current.memoizedState),
                        (props.updateQueue = current.updateQueue),
                        (props.type = current.type),
                        (propKey = current.dependencies),
                        (props.dependencies =
                          null === propKey
                            ? null
                            : {
                        ...
                        (props.selfBaseDuration = current.selfBaseDuration),
                        (props.treeBaseDuration = current.treeBaseDuration)),
                    (renderLanes = renderLanes.sibling);
                push(
                  suspenseStackCursor,
...
function createClassErrorUpdate(fiber, errorInfo, lane) {
  ...
  if ("function" === typeof getDerivedStateFromError) {
    var error$127 = errorInfo.value;
    lane.payload = function() {
      logCapturedError(fiber, errorInfo);
      return getDerivedStateFromError(error$127);
    };
  }
    ...
    if (0 !== (firstChild.subtreeFlags & 4628) && null !== root)
      ...
      for (; null !== nextEffect; ) {
        ...
        try {
          ...
          captureCommitPhaseError(firstChild, firstChild.return, error$135);
        }
          ...
          try {
            ...
            if (0 !== (fiber$jscomp$0.flags & 68))
              switch (fiber$jscomp$0.tag) {
                ...
                case 11:
                case 15:
                  if (fiber$jscomp$0.mode & 2)
                    try {
                      startLayoutEffectTimer(),
                        commitHookEffectListMount(3, fiber$jscomp$0);
                    } finally {
                      recordLayoutEffectDuration(fiber$jscomp$0);
                    }
                  else commitHookEffectListMount(3, fiber$jscomp$0);
                  break;
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$138 = fiber$jscomp$0.updateQueue;
                  if (null !== updateQueue$138) {
                    finishedRoot = null;
                  ...
                  break;
                case 5:
                  var instance$140 = fiber$jscomp$0.stateNode;
                  null === current &&
                    fiber$jscomp$0.flags & 4 &&
                    ((finishedRoot = instance$140),
                ...
                case 4:
                  break;
                case 12:
                  var _finishedWork$memoize2 = fiber$jscomp$0.memoizedProps,
                    onCommit = _finishedWork$memoize2.onCommit,
                    onRender = _finishedWork$memoize2.onRender,
                    effectDuration = fiber$jscomp$0.stateNode.effectDuration,
                    commitTime$141 = commitTime;
                  ...
                  enqueuePendingPassiveProfilerEffect(fiber$jscomp$0);
                  for (
                    var parentFiber = fiber$jscomp$0.return;
                    null !== parentFiber;

                  ) {
                    if (12 === parentFiber.tag) {
...
function scheduleUpdateOnFiber(fiber, lane, eventTime) {
  ...
  if (
    ...
    for (; null !== fiber; ) {
      if (12 === fiber.tag) {
        var _current$memoizedProp = fiber.memoizedProps,
        ...
        "function" === typeof _current$memoizedProp &&
          _current$memoizedProp(id, root.memoizedInteractions);
      }
      fiber = fiber.return;
    }
...
function performConcurrentWorkOnRoot(root, didTimeout) {
  ...
  if (
    ...
    resetRenderTimer(),
      ...
      startWorkOnPendingInteractions(root, didTimeout);
    ...
    switch (didTimeout) {
      ...
      case 4:
        ...
        for (prevExecutionContext = -1; 0 < lanes; )
          (prevInteractions = 31 - clz32(lanes)),
            (prevDispatcher = 1 << prevInteractions),
            (prevInteractions = didTimeout[prevInteractions]),
            prevInteractions > prevExecutionContext &&
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$128 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$128.tag)) {
              var nextState = workInProgress$128.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$128.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$128.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$128.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (
                0 === (workInProgress$128.mode & 1) &&
                workInProgress$128 !== returnFiber
              ) {
                workInProgress$128.flags |= 128;
              ...
              workInProgress$128.flags |= 16384;
              workInProgress$128.lanes = thrownValue;
              break a;
            }
            workInProgress$128 = workInProgress$128.return;
          } while (null !== workInProgress$128);
          value = Error(
        ...
        workInProgress$128 = returnFiber;
        do {
          switch (workInProgress$128.tag) {
            case 3:
              root = value;
              workInProgress$128.flags |= 16384;
              thrownValue &= -thrownValue;
              workInProgress$128.lanes |= thrownValue;
              var update$130 = createRootErrorUpdate(
                workInProgress$128,
                root,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$128, update$130);
              break a;
            case 1:
              root = value;
              var ctor = workInProgress$128.type,
                instance = workInProgress$128.stateNode;
              if (
                0 === (workInProgress$128.flags & 128) &&
                ...
                thrownValue &= -thrownValue;
                workInProgress$128.lanes |= thrownValue;
                var update$133 = createClassErrorUpdate(
                  workInProgress$128,
                  root,
                  thrownValue
                );
                enqueueCapturedUpdate(workInProgress$128, update$133);
                break a;
              }
          }
          workInProgress$128 = workInProgress$128.return;
    ...
    if (null !== spawnedWorkDuringRender)
      for (
        prevInteractions = spawnedWorkDuringRender,
          spawnedWorkDuringRender = null,
          shouldFireAfterActiveInstanceBlur$154 = 0;
        shouldFireAfterActiveInstanceBlur$154 < prevInteractions.length;
        shouldFireAfterActiveInstanceBlur$154++
      )
        scheduleInteractions(
          root,
          prevInteractions[shouldFireAfterActiveInstanceBlur$154],
              ...
              case 12:
                ...
                "function" === typeof onPostCommit &&
                  onPostCommit(
                    ...
                    sibling$jscomp$1,
                    priorityLevel.memoizedInteractions
                  );
                for (
  ...
  switch (fiber.tag) {
    case 3:
      ...
      if (root$160.hydrate) {
        ...
        root$160.expiredLanes |= lanes & root$160.pendingLanes;
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1439 = {
...
var internals$jscomp$inline_1863 = {
  bundleType: devToolsConfig$jscomp$inline_1439.bundleType,
  version: devToolsConfig$jscomp$inline_1439.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1439.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1439.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1439.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1864 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1864.isDisabled &&
    hook$jscomp$inline_1864.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1864.inject(
        internals$jscomp$inline_1863
      )),
        (injectedHook = hook$jscomp$inline_1864);
    } catch (err) {}
}
