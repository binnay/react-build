...
function readChunk(chunk) {
  switch (chunk._status) {
    ...
    case 2:
      return (
        (value = ReactFlightDOMRelayClientIntegration.requireModule(
          chunk._value
        )),
        (chunk._status = 3),
        (chunk._value = value)
  ...
  if ("J" === chunk$jscomp$0[0]) {
    ...
    "M" === chunk$jscomp$0[0]
      ? ((id = chunk$jscomp$0[1]),
        ...
        (chunks = ReactFlightDOMRelayClientIntegration.resolveModuleReference(
          chunks
        )),
        ReactFlightDOMRelayClientIntegration.preloadModule(chunks),
        chunk$jscomp$0
