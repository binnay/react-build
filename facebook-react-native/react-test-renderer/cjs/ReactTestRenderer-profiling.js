    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$62.lanes | child$62.childLanes),
          (subtreeFlags |= child$62.subtreeFlags & 262144),
          (subtreeFlags |= child$62.flags & 262144),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$61.subtreeFlags & 262144),
          (subtreeFlags |= treeBaseDuration$61.flags & 262144),
                  ...
                  (renderLanes = newProps),
                    ...
                    null === type
                      ? ((renderLanes.childLanes = 0),
                        (renderLanes.lanes = renderedTail),
                      ...
                      : ((renderLanes.childLanes = type.childLanes),
                        ...
                        (renderedTail = type.dependencies),
          ...
          try {
            ...
            if (0 !== (fiber$jscomp$0.flags & 68))
              switch (fiber$jscomp$0.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$81 = fiber$jscomp$0.updateQueue;
                      ...
                      switch (fiber$jscomp$0.child.tag) {
                        case 5:
                          finishedRoot = getPublicInstance(
                            fiber$jscomp$0.child.stateNode
                          );
                          break;
                        case 1:
            ...
            if (fiber$jscomp$0.flags & 256) {
              ...
              if (null !== ref) {
                ...
                switch (fiber$jscomp$0.tag) {
                  case 5:
                    finishedRoot = getPublicInstance(instance$jscomp$0);
                    break;
                  default:
...
var devToolsConfig$jscomp$inline_846 = {
...
var internals$jscomp$inline_1063 = {
  bundleType: devToolsConfig$jscomp$inline_846.bundleType,
  version: devToolsConfig$jscomp$inline_846.version,
  rendererPackageName: devToolsConfig$jscomp$inline_846.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_846.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_846.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1064 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1064.isDisabled &&
    hook$jscomp$inline_1064.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1064.inject(
        internals$jscomp$inline_1063
      )),
        (injectedHook = hook$jscomp$inline_1064);
    } catch (err) {}
}
