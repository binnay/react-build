...
function restoreSpawnedCachePool(offscreenWorkInProgress, prevCachePool) {
  ...
  var nextParentCache = isPrimaryRenderer ? CacheContext._currentValue : CacheContext._currentValue2;
...
function warnIfNotCurrentlyActingEffectsInDEV(fiber) {
  {
    if (warnsIfNotActing === true && (fiber.mode & StrictLegacyMode) !== NoMode && IsSomeRendererActing.current === false && IsThisRendererActing.current === false) {
...
exports.ContinuousEventPriority = InputContinuousLanePriority;
exports.DefaultEventPriority = DefaultLanePriority;
exports.DiscreteEventPriority = InputDiscreteLanePriority;
exports.IdleEventPriority = IdleLanePriority;
